    ...
    <div id="page-inner">
        ...
        <div style="margin: auto; max-width: 600px; width: 100%; padding: 2em;">
            ...
            <form method="post" enctype="multipart/form-data"
                action="@if (isset($modificar_planta)) {{ route('admin.mayor.modificar') }} @else {{ route('admin.mayor.crear') }} @endif">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="pedido_minimo"
                        value="@if (isset($modificar_mayor)) {{ $modificar_mayor->pedido_minimo }} @else {{ old('pedido_minimo') }} @endif"
                        class="form-control" id="inputText" required>
                </div><br>
                <!-- boton tipo submit -->
                <div class="col-12">
